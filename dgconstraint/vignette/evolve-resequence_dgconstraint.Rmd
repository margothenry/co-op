...
* Before you start the analysis, you need to ensure that:
  ...
  + Decide which function to use with your data:
    + `single_generation_wide`: sequencing data was obtained from a single generation. Mutation presence/absence is in a separate column for each population. Population information is located in the column header.
    + `single_generation_long`: sequencing data was obtained from a single generation. Mutation presence/absence is in a single column. Population information is indicated in a single, separate column.
