...
#################################################################################################
data <- read_csv("/Users/Margot/Desktop/Co-op/data-in/Sherlock 2019.csv")
...
generations <- c("0","50","100","150","200" ,"250","300","350","400","450","500")
multiple <- TRUE
...
if (multiple == TRUE) {
  ...
  for (g in generations) {
   #####################################################################################################################
    ...
    write_csv(data.g, path = paste0("data-out/Sherlock2019_", g, ".csv"))
