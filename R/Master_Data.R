...
multiple_wide("Tenaillon2016", "Davis minimal medium", c("g500", "g1000", "g1500", "g2000", 'g5000', 'g10000', 'g20000', 'g30000', 'g40000','g50000'), "Davis minimal medium", "Ecoli_K12")
...
multiple_wide("Lang2013", "YPD", c("0","140","240","335",'415','505','585','665','745','825','910','1000'), "YPD", "Sac")
...
multiple_wide("Sherlock2013", "YPD", c("G7","G70", "G133","G196","G266", "G322","G385","G448"), "YPD", "Sac")
...
write_csv(Hong2014, here("data_in", "for_func", "Hong2014.csv"))
...
Jerison2017_OT <- Jerison2017 %>% 
  ...
  rename(gene = Gene, population = Population)
write_csv(Jerison2017_OT, here("data_in", "for_func", "Jerison2017_OT.csv"))
...
Jerison2017_HT <- Jerison2017 %>% 
  ...
  rename(gene = Gene, population = Population)
write_csv(Jerison2017_HT, here("data_in", "for_func", "Jerison2017_HT.csv"))
...
Payen2016 <- Payen2016 %>% 
  ...
  drop_na(frequency) 
write_csv(Payen2016, here("data_in", "for_func", "Payen2016.csv"))
...
McCloskey2018 <- McCloskey2018 %>% 
  filter(mutation_locations != "intergenic")
write_csv(McCloskey2018, here("data_in", "for_func", "McCloskey2018.csv"))
...
write_csv(Ramiro2016, here("data_in", "for_func", "Ramiro2016.csv"))
...
### (Tri) Only load the library "plyr" for this line of code - calling this library earlier would lead to "unused arguments" error when using here().
